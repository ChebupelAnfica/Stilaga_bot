...
from states.record import Form
...
@dp.callback_query(lambda call: call.data == 'collect_data')
async def collect_start(callback_query: types.CallbackQuery, state: FSMContext):
    try:
